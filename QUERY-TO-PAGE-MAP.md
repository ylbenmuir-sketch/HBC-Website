...
| Nashville local | `/neurofeedback-nashville/` | `neurofeedback nashville` | lens therapy nashville, biofeedback nashville, brain mapping nashville, neurofeedback near me | 2,930 impr pos 10.2 · 193 GBP | **Missing — P0** |
| Murfreesboro local | `/neurofeedback-murfreesboro/` | `neurofeedback murfreesboro` | lens therapy murfreesboro, neurofeedback rutherford county, smyrna / christiana / la vergne | 325 impr **pos 3.5, 0 clicks** | **Missing — P0** |
...
2. `/neurofeedback-nashville/` and `/neurofeedback-murfreesboro/` — no dedicated location pages exist for a two-location practice
