...
import { FOUNDER_DISPLAY_NAME } from "@/lib/site-config";
      ...
      <section className="sec">
        <div className="wrap article rv">
          <p className="lede">
            ...
            Sheri: what led her to LENS, the first clients, the conviction that
            became the care model, and why the practice trains others rather
            than staying a solo practice.]
          </p>
          <blockquote>
            &ldquo;The measure of our work isn&rsquo;t a chart. It&rsquo;s how
            you actually feel, week to week.&rdquo;
          </blockquote>
          <p>
          ...
          <p>
            [Paragraph on what&rsquo;s next: Franklin, and bringing the same
            standard to more communities.]
          </p>
        </div>
      </section>
      ...
      <section className="sec sec-ivory2">
        <div className="wrap split">
          ...
          <div className="rv">
            ...
            <p>
              Sheri still sees clients and personally trains every practitioner
              &mdash; but the Harmonized care model is designed so every
              client, at every center, gets the same standard she set.
            </p>
